	...
	var tests = []row{
		{
			...
			num_20_0:   1232543,
			num_6_3:    12.73,
			date:       time.Date(2012, 5, 19, 0, 0, 0, 0, TimeZone),
			float_2_0:  23,
		...
		},
		{
			...
			num_20_0:   4564568,
			num_6_3:    2,
			date:       time.Date(2012, 5, 20, 0, 0, 0, 0, TimeZone),
			float_2_0:  1,
			float_20_0: 234,
			float_6_3:  0.123,
			logical:    false,
		...
		},
		{
			...
			num_6_3:    99.99,
			date:       time.Date(2012, 5, 21, 0, 0, 0, 0, TimeZone),
			float_2_0:  23,
			float_20_0: 457768,
			float_6_3:  99,
			logical:    true,
		...
		},
		{
			...
			num_20_0:   234456,
			num_6_3:    0.123,
			date:       time.Date(2012, 5, 22, 0, 0, 0, 0, TimeZone),
			float_2_0:  65,
			float_20_0: 234,
			float_6_3:  1,
			logical:    false,
